    ...
    <section className="bg-white">
      <div className="container">
        <div className="flex justify-center items-center">
          <div className="tag md:block hidden">Version 2.0 is here</div>
          <div className="tag md:hidden mb-2">Testimonials</div>
        </div>
        <h2 className="gradient-heading text-center">What our users say</h2>
